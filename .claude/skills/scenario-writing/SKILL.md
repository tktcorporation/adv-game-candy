...
目標:          55-65% 会話 / 35-45% ナレーション ← 文学的空気感を保ちつつ会話を増やす
```

**リンターで自動チェックされる。55%未満で警告が出る。**

ナレーションを減らすのではなく、**会話を足す**。
残すナレーションは「詩的・感覚的」（コーヒーの香り、光の角度、音）であり、
...
完全に無言でいさせる場合は、**非言語リアクション**を最低1つ入れること:
